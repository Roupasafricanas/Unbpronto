...
public class Config {
     ...
     * Point url to JSON or leaveoutside empty to use config.json from assets.
     */

    public static final String CONFIG_URL = "Whatsapp://";
    ...
    public static final boolean OPEN_INLINE_EXTERNAL = true;
